...
public class Swatch3d: MonoBehaviour {
	...
	public void test(Vector3 right, Vector3 forward,float width = 3.0f) {
		paintConsider(Vector3.up * 100 ,right,forward,width);
		paintConsider(Vector3.up * 100 + Vector3.forward * 100,right,forward,width);
		paintConsider(Vector3.up *-100 + Vector3.forward * 100,right,forward,width);
		paintConsider(Vector3.up * 0 ,right,forward,width);
		paintConsider(Vector3.up * 0 + Vector3.left * 100,right,forward,width);
	}
	...
	public void paintConsider(Vector3 xyz, Vector3 right, Vector3 forward,float width = 3.0f ) {
